...
export default function DAOWhitelistModal({ 
  isOpen, 
  onClose, 
  whitelist, 
  addressInput, 
  ...
  return (
    <EnhancedModal
      isOpen={isOpen}
      onClose={onClose}
      title="🏛️ DAO Governance Whitelist"
      subtitle="Manage DAO Access Permissions"
      titleColor="#3b82f6"
    ...
    >
      ...
      <ModalCard
        ...
        gradient="linear-gradient(135deg, rgba(59,130,246,0.15), rgba(37,99,235,0.15))"
      >
        <div style={{ maxHeight: 400, overflowY: 'auto', padding: 10, border: '1px solid rgba(59,130,246,0.3)', borderRadius: 8 }}>
          {whitelist.length === 0 && (
          ...
          {whitelist.map((addr) => (
            ...
            >
              <div>
                <div style={{ fontWeight: 600, color: '#60a5fa', fontSize: '1.1rem' }}>
